...
%Solidity can be annotated with Why3 statements to reason about the correctness of the contract~\cite{Reitwiessner2015Why3}. %Oyente can be used as well, but will compile code into a Control Flow Graph (CFG). 
